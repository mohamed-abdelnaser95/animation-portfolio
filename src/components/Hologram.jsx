...
Command: npx gltfjsx@6.2.18 hologram.gltf --transform 
Files: hologram.gltf [857.6KB] > C:\Users\moham\OneDrive\Desktop\hologram\hologram-transformed.glb [164.16KB] (81%)
...
export default function Hologram(props) {
  const group = useRef()
  const { nodes, materials, animations } = useGLTF('/img/hologram-transformed.glb')
...
useGLTF.preload('/img/hologram-transformed.glb')
